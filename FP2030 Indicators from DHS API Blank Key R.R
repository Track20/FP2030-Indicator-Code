...
url<-("http://api.dhsprogram.com/rest/dhs/data?f=json&indicatorIds=FP_NADA_W_UMT&surveyid=all&breakdown=all&perpage=20000&APIkey=")
jsondata<-fromJSON(url) 
dta<-data.table(jsondata$Data)
...
url<-("http://api.dhsprogram.com/rest/dhs/data?f=json&indicatorIds=FP_NADA_W_PDM&surveyid=all&breakdown=all&perpage=20000&APIkey=")
jsondata<-fromJSON(url) 
dta<-data.table(jsondata$Data)
...
url<-("http://api.dhsprogram.com/rest/dhs/data?f=json&indicatorIds=FP_CUSA_W_PIL,FP_CUSA_W_MOD&surveyid=all&breakdown=all&perpage=30000&APIkey=")
jsondata<-fromJSON(url) 
dta<-data.table(jsondata$Data)
...
url<-("http://api.dhsprogram.com/rest/dhs/data?f=json&indicatorIds=FE_FRTR_W_A15&surveyid=all&breakdown=all&perpage=20000&APIkey=")
jsondata<-fromJSON(url) 
dta<-data.table(jsondata$Data)
...
url<-("http://api.dhsprogram.com/rest/dhs/data?f=json&indicatorIds=PR_PLST_W_LAT,PR_PLST_W_NOM&surveyid=all&breakdown=all&perpage=30000&APIkey=")
jsondata<-fromJSON(url) 
dta<-data.table(jsondata$Data)
...
url<-("http://api.dhsprogram.com/rest/dhs/data?f=json&indicatorIds=FP_DMKF_W_UWF,FP_DMKF_W_UJN&surveyid=all&breakdown=all&perpage=30000&APIkey=")
jsondata<-fromJSON(url) 
dta<-data.table(jsondata$Data)
